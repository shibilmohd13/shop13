...
def edit_products(request, id):
    ...
    print(prod)
    context = {"cat": category_list, "bnd": brands_list, "prod": prod, "colors": colors}
...
def varient_details(request, id):
    prod = (
        ...
        .prefetch_related("colorvarient_set__productimage_set")
        .first()
    )
...
def edit_varients(request, id):
    ...
    return render(
        request,
        "admin_panel/edit_varients.html",
        {"variant": varient, "product": varient.product, "images": existing_images},
    )

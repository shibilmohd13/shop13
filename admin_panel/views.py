...
def add_product_offers(request):
    ...
    return render(
        request, "admin_panel/add_offers_product.html", {"products": products}
    )
...
def edit_product_offers(request, id):
    ...
    return render(
        request,
        "admin_panel/edit_offers_product.html",
...
def add_category_offers(request, id):
    ...
    return render(
        request, "admin_panel/add_offers_category.html", {"category": category}
    )
...
def edit_banners(request, id):
    ...
    return render(
        request,
        "admin_panel/edit_banners.html",
        {"banner": banner, "products": products},
    )
